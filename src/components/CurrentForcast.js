        ...
        < >
            {
                (previousForcast.length >= 5 ) && (
                    <div className={ `${ defaultClassname } flex-column justify-content-start align-items-between current-forcast mb-3` }>
                        ...
                        {/* Temperature */}
                        <div className={ `${ defaultClassname } ${ rowBetween } align-items-center pb-3`} >
                        ...
                        <div className={ `${ defaultClassname } ${ rowBetween } `} >
                            ...
                            {/* feels like */}
                            <div className={ `${ defaultClassname } flex-column justify-content-end px-2`}>
                                <div >{'Feels' }</div>
                                <div className={ 'feel-like '}>{ `${Math.round(data.main.feels_like)}°C` }</div>
                            </div>

                            {/* High and low */}
                            <div className={ `${ defaultClassname } flex-row justify-content-center align-items-end feel-like  px-2`} >
